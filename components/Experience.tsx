  ...
  return (
    ...
    >
      <Reveal className="max-w-[1320px] mx-auto grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-[clamp(40px,6vw,90px)] items-start">
        <div>
          <p className="text-[12px] tracking-[0.2em] uppercase text-[#9a7b5f] mb-[24px]">
            {t.expLabel}
          </p>
        ...
        <div className="border-l border-[#d8d1c3]">
          {experience.map((e) => (
            <div
              key={e.period}
              className="group relative pl-[clamp(26px,3vw,40px)] pb-[clamp(34px,5vh,48px)] cursor-default"
            >
              <span className="absolute left-[-5px] top-[6px] w-[9px] h-[9px] rounded-full bg-[#9a7b5f] transition-all duration-300 group-hover:scale-150 group-hover:shadow-[0_0_0_4px_rgba(154,123,95,0.18)]" />
              <div className="transition-transform duration-300 group-hover:translate-x-[6px]">
                ...
                <h3 className="font-serif font-semibold text-[clamp(20px,1.6vw,24px)] leading-[1.2] transition-colors duration-300 group-hover:text-[#9a7b5f]">
                  {e.role}
                </h3>
                <p className="text-[14px] text-[#9a7b5f] my-[4px] mb-[12px] tracking-[0.02em]">
                  {e.org}
                </p>
